...
message = tk.Label(window, text="INVERTIS UNIVERSITY" ,bg="white"  ,fg="black"  ,width=20  ,height=2,font=('Times New Roman', 25, 'bold')) 
...
message2 = tk.Label(window, text="" ,fg="red"   ,bg="yellow",activeforeground = "green",width=55  ,height=4  ,font=('times', 15, ' bold ')) 
message2.place(x=650, y=575-y_cord)
